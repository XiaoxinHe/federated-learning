...
public class averaging {
    private static final String updatedModel = "res/model/trained_nn_updated.zip";
    private static final String originModel = "res/model/trained_nn.zip";
    private static final String onDeviceModelPath = "res/model/onDeviceModelPath";
    ...
    public static void AverageWeights(List<File> files, File originModel, int layer, double alpha) {
        ...
        INDArray weight = paramTable.get(String.format("%d_W", layer));//INDArray: n-dimensional array
